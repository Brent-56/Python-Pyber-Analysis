...
#2 Here we are going to merge both CSVs("city_data.csv", "ride_data.csv") together on the "city" column which is a column that both datasets have individually. This is similar to how we use joins in SQL. 
